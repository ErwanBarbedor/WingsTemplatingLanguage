--[[
Plume Templating Langage v1.0.0-alpha
Copyright (C) 2023  Erwan Barbedor

Check https://github.com/ErwanBarbedor/Plume-Templating-Langage
...
Plume._VERSION = "Plume Templating Langage 1.0.0-alpha"

-- Empty function used as a placeholder for lua 5.1 compatibility
